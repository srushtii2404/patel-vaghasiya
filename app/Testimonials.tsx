...
const Testimonials: React.FC = () => {
  ...
  return (
    <div className="w-full bg-main py-10">
      {/* Content Wrapper */}
      <div className="max-w-7xl mx-auto px-6">
        ...
        {loading ? (
          ...
          <div className="relative">
                  ...
                  <div className="p-6 bg-white rounded-2xl shadow hover:shadow-lg transition h-full flex flex-col justify-between min-h-[280px]">
                    ...
                    <div className="flex items-center gap-3 mt-4 pt-4 border-t border-gray-100">
                      {testimonial.image?.asset?.url ? (
                        ...
                        <div
                          className={`w-12 h-12 rounded-full ${avatarBgClass(
                            testimonial.name
            ...
            {/* Arrows */}
            <button className="swiper-button-prev-testimonial absolute left-[-10px] top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-main hover:text-white transition">
              <FaChevronLeft />
            </button>

            <button className="swiper-button-next-testimonial absolute right-[-10px] top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-main hover:text-white transition">
              <FaChevronRight />
            </button>
          </div>
        )}
