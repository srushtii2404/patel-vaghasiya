...
export default function ProjectLoanPage() {
    ...
    return (
        <>
            ...
            {/* ---------------- HERO SECTION ---------------- */}
            <section className="relative bg-gradient-to-r from-[#134c78] to-[#398db8] rounded-4xl mx-2 py-20 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-20 flex gap-10 py-20 section-bg">
                ...
                <div className="flex-1 space-y-16">
                    ...
                    <motion.section
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <h2 className="text-4xl font-extrabold gradient-heading">Who Can Apply for a Project Loan?</h2>
