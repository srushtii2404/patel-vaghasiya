        ...
        <>
            ...
            <section className="relative bg-gradient-to-r from-[#134c78] to-[#398db8] rounded-4xl mx-2 py-20 overflow-hidden mt-28">
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-20 flex flex-col lg:flex-row items-start gap-10 relative z-10">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-bold text-white">IPO Advisory & Support Services</h1>
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-20 flex gap-10 py-20 section-bg">
                <div className="flex-1 space-y-16">
                    ...
                    <motion.section
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-4xl font-extrabold gradient-heading">Why Choose Us for IPO Advisory?</h2>
                    ...
                    <motion.section
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-4xl font-extrabold gradient-heading">Our Core Services</h2>
                    ...
                    <motion.section className="space-y-6" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
                        <h2 className="text-4xl font-extrabold gradient-heading">Why Companies Trust Us</h2>
